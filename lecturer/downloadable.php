                    ...
                    <div class="mdk-drawer-layout__content page ">
                        ...
                        <div class="container-fluid page__container">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Add Materials
								</li>
                            </ol>
																		...
																		<?php
																			...
																			<td width="10%">
																				<div class="col-lg-12" style="margin-bottom: 5%;">
																					    ...
																					    <a class="btn btn-info "  href="<?php echo $row['floc']; ?>"> <i style="color: #fff;"  class="material-icons">get_app	</i></a>
