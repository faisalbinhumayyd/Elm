                            ...
                            <div class="card">
                                <ul class="nav nav-tabs nav-tabs-card" style="background-color: #03a9f4;">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link"
                                           href="#fourth"
                                            data-toggle="tab"  >Delete my account</a> 
                                    </li>
                                </ul>
                                <div  class="tab-content card-body">
                                <?php include('change_profile_lecturer_form.php'); ?>
                                   
                                <?php include('avatar_modal_lecturer.php'); ?>	  
                                    
                                <?php include('change_password_lecturer.php'); ?>
 
                                <?php include('delete_account_lecturer.php'); ?>
                                </div>
                            </div>
                        </div>
