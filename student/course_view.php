					...
					<div class="container-fluid page__container">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    $course_query = mysqli_query($conn, "SELECT * from course  where course_id = '$get_id' 
                                    ") or die(mysqli_error());
                                   ($course_row = mysqli_fetch_array($course_query)
                                       ...
                                       $ext = pathinfo($course_row['floc'], PATHINFO_EXTENSION);
                                        ?>
                                            <img width="100%" src="../avatar_course/uploads/<?php echo $course_row['location']; ?>" />
                                     
                                     <?php
                                        if ($c_count != 0) {
												?> 
                                     <br/><hr/>
                                      <a href="materials_list.php?id=<?php echo $_GET['id']; ?>" class="btn btn-success btn-lg btn-block" >Go To Materials</a>
